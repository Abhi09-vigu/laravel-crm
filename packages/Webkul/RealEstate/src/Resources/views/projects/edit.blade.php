<x-admin::layouts>
    <!-- Page Title -->
    <x-slot:title>
        @lang('real_estate::app.projects.edit.title')
    </x-slot>

    <!-- Edit Project Form -->
    <x-admin::form
        :action="route('admin.real_estate.projects.update', $project->id)"
        method="PUT"
    >
        <div class="flex flex-col gap-4">
            ...
            <div class="scroll-reactive-sticky sticky top-[60px] z-[1000] flex items-center justify-between rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm shadow-sm dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300">
                <div class="flex flex-col gap-2">
                    <!-- Breadcrumbs -->
                    <x-admin::breadcrumbs
                        name="real_estate.projects.edit"
                        :entity="$project"
                    />

                    <div class="text-xl font-bold dark:text-white">
                        @lang('real_estate::app.projects.edit.title'): {{ $project->project_name }}
                    </div>
                </div>
                ...
                <div class="flex items-center gap-x-2.5">
                    @if (bouncer()->hasPermission('real_estate.projects.edit'))
                        ...
                        >
                            @lang('real_estate::app.projects.edit.save-btn')
                        </button>
                    @endif
                </div>
            </div>
                    ...
                    <div class="box-shadow rounded-lg border border-gray-300 bg-white p-4 dark:border-gray-800 dark:bg-gray-900">
                        ...
                        <x-admin::form.control-group>
                            ...
                            <x-admin::form.control-group.control
                                ...
                                name="developer_name"
                                rules="required"
                                :value="old('developer_name', $project->developer_name)"
                        ...
                        <x-admin::form.control-group>
                            ...
                            >
                                <option value="apartment" {{ old('project_type', $project->project_type) == 'apartment' ? 'selected' : '' }}>
                                    @lang('real_estate::app.projects.type-apartment')
                                </option>
                                <option value="villa" {{ old('project_type', $project->project_type) == 'villa' ? 'selected' : '' }}>
                                    @lang('real_estate::app.projects.type-villa')
                                </option>
                                <option value="plot" {{ old('project_type', $project->project_type) == 'plot' ? 'selected' : '' }}>
                                    @lang('real_estate::app.projects.type-plot')
                                </option>
                                <option value="commercial" {{ old('project_type', $project->project_type) == 'commercial' ? 'selected' : '' }}>
                    ...
                    <div class="box-shadow rounded-lg border border-gray-300 bg-white p-4 dark:border-gray-800 dark:bg-gray-900">
                        ...
                        <x-admin::form.control-group>
                            ...
                            <x-admin::form.control-group.control
                                ...
                                :value="old('total_land_area', $project->total_land_area)"
                        ...
                        <x-admin::form.control-group>
                            ...
                            <x-admin::form.control-group.control
                                ...
                                :value="old('total_buildings_towers', $project->total_buildings_towers)"
                        ...
                        <x-admin::form.control-group class="!mb-0">
                            ...
                            <x-admin::form.control-group.control
                                ...
                                :value="old('expected_completion_date', $project->expected_completion_date ? $project->expected_completion_date->format('Y-m-d') : '')"
